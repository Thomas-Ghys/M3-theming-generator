...
export function addLightTheme(destinationPathName: string, color: string) {
    ...
    if (color !== 'surface') {
        createTemplatesFile(destinationPathName, color, templatesPath, 'base-light-theme.txt');
        return;
    }
    
    createTemplatesFile(destinationPathName, color, templatesPath, 'base-light-surface-theme.txt');
}